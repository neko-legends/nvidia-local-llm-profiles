...
rem ============================================================
rem  NVIDIA Qwen3.6 35B A3B NVFP4 MTP GGUF llama.cpp launcher.
rem  Endpoint: http://127.0.0.1:39194/v1
rem
...
set "MODEL_PATH=%MODEL_CACHE_DIR%\qwen3.6-35b-a3b-nvfp4-mtp.gguf"
...
if not exist "%MODEL_PATH%" (
  ...
  echo   convert-qwen36-35b-a3b-nvfp4-mtp-to-gguf.bat
  echo.
  pause
  exit /b 1
)
