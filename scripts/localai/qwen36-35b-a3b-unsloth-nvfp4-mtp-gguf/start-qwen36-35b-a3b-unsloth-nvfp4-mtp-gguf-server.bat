...
rem Native Windows llama.cpp launcher for Unsloth Qwen3.6 35B A3B NVFP4 MTP GGUF.
set "SCRIPT_DIR=%~dp0"
for %%I in ("%SCRIPT_DIR%..\..\..\..") do set "CHECKOUT_PARENT=%%~fI"
set "MODEL_CACHE_DIR=%CHECKOUT_PARENT%\.local-model-cache\unsloth\Qwen3.6-35B-A3B-NVFP4-MTP-GGUF"
if not defined MODEL_PATH set "MODEL_PATH=%MODEL_CACHE_DIR%\qwen3.6-35b-a3b-unsloth-nvfp4-mtp-gguf.gguf"
set "MODEL_ALIAS=qwen36-35b-a3b-unsloth-nvfp4-mtp-gguf"
set "PORT=39197"
set "CTX_SIZE=200000"
set "THINKING=0"
