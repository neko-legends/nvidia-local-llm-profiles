...
set "SCRIPT_DIR=%~dp0"
set "BENCH_WITH_SERVER=%SCRIPT_DIR%bench-with-server-ornith-1.0-35b-q4-k-m.ps1"
...
echo Benchmarking Ornith 1.0 35B Q4_K_M with llama.cpp.
echo.
echo This starts llama-server on http://127.0.0.1:39188/v1, runs the saved
