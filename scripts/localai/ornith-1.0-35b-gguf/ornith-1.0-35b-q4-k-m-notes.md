...
| ---: | ---: | ---: | ---: | ---: |
| 10k reference | 8,905 | 201.5 | 1.7s | 149.7 |
| 200k reference | 174,588 | 106.7 | 40.3s | 20.3 |

The 200k prompt read time is from the sequential two-point wrapper, so llama.cpp
reused the prefix cached by the preceding 10k run and processed 166,199 new
prompt tokens. The full-request tok/s column is completion tokens divided by
