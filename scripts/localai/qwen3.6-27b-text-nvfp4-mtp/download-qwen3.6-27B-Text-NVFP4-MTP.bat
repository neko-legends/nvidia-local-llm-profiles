...
set "LOCALAI_DIR=D:\Tools\LocalAI"
if not exist "%LOCALAI_DIR%" set "LOCALAI_DIR=%~dp0"
set "MODEL_DIR=%LOCALAI_DIR%\models\Qwen3.6-27B-Text-NVFP4-MTP"
