...
rem ============================================================
rem  Download Qwopus3.6 35B A3B Coder MTP Q4_K_M GGUF.
rem  Default target:
...
set "FILENAME=Qwopus3.6-35B-A3B-Coder-MTP-Q4_K_M.gguf"
...
echo   start-qwopus3.6-35b-a3b-coder-mtp-q4-k-m-server.bat
echo.
pause
