...
rem ============================================================
rem  Qwopus3.6 35B A3B Coder MTP Q4_K_M llama.cpp launcher.
rem  Endpoint: http://127.0.0.1:39193/v1
rem
...
set "MODEL_PATH=%MODEL_CACHE_DIR%\Qwopus3.6-35B-A3B-Coder-MTP-Q4_K_M.gguf"
set "MODEL_ALIAS=qwopus3.6-35b-a3b-coder-mtp-q4-k-m"
set "HOST=0.0.0.0"
set "PORT=39193"
set "CTX_SIZE=200000"
set "THINKING=0"
...
if not exist "%MODEL_PATH%" (
  ...
  echo   download-qwopus3.6-35b-a3b-coder-mtp-q4-k-m.bat
  echo.
  pause
  exit /b 1
)
