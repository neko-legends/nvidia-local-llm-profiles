...
rem Download Unsloth Qwen3.6 27B NVFP4 source weights.
set "SCRIPT_DIR=%~dp0"
for %%I in ("%SCRIPT_DIR%..\..\..\..") do set "CHECKOUT_PARENT=%%~fI"
set "REPO_ID=unsloth/Qwen3.6-27B-NVFP4"
if not defined MODEL_DIR set "MODEL_DIR=%CHECKOUT_PARENT%\.local-model-cache\unsloth\Qwen3.6-27B-NVFP4"
...
echo Download complete. Run convert-qwen36-27b-unsloth-nvfp4-to-gguf.bat next.
pause
exit /b 0
